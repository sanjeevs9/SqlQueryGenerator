...
exports.UI_DESIGN_PROMPT = exports.DATABASE_DESIGN_PROMPT = void 0;
exports.DATABASE_DESIGN_PROMPT = `YYou are an AI agent acting as a PostgreSQL database creator. Your task is to generate SQL statements for building a comprehensive database for a product multi-vendor marketplace based on the given description. Follow these instructions carefully:
...
.`;
exports.UI_DESIGN_PROMPT = `You are a UI/UX design expert. Generate a JSON representation of a responsive UI layout based on the given description.
Consider:
